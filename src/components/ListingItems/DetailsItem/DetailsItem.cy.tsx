describe('Details', () => {
    ...
    it(' Single DetailsItem in Panel ', () => {
        cy.visit('/iframe.html?id=components-list-items-details--single-item-panel')
    ...
    it('DetailsItem stack list with shadows ', () => {
        cy.visit('/iframe.html?id=components-list-items-details--stacked-list-panel')
    ...
    it('DetailsItem stack list with title ', () => {
        cy.visit('/iframe.html?id=components-list-items-details--stacked-list-panel-title')
        cy.get(`.cu-panel`).should('exist')
        cy.get(`.shadow-lg`).should('exist')
