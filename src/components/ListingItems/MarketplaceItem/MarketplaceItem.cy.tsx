describe('Marketplace', () => {
    ...
    it(' Single Marketplace in Panel ', () => {
        cy.visit('/iframe.html?id=components-list-items-marketplace--single-item-panel')
    ...
    it('Marketplace stack list with shadows ', () => {
        cy.visit('/iframe.html?id=components-list-items-marketplace--stacked-list-panel')
    ...
    it('Marketplace stack list with title ', () => {
        cy.visit('/iframe.html?id=components-list-items-marketplace--stacked-list-panel-title')
        cy.get(`.cu-panel`).should('exist')
        cy.get(`.shadow-lg`).should('exist')
