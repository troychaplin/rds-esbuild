...
import { TopNav, Banner, FooterBasic, DetailsItem, Button } from '../../../components'
import { Main, Column, Aside, Container, Panel, StackedList, Article } from '../../../layouts'
                ...
                <Column cols='2/3' maxWidth='7xl'>
                    ...
                    <Aside isSticky topSpace='8'>
                        <Column cols='1' gridGap='5'>
                            ...
                            <Button isType='grey' onClick={() => {}} title='Add to my events' />
                        </Column>
                        <Panel hasShadow>
