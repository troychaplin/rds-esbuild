describe('Container', () => {
    ...
    it(' Container Default with transparent Background ', () => {
        ...
        cy.get('div').should('have.class', 'cu-container').and('have.class', 'bg-transparent')
    ...
    it(' Container Grey background', () => {
        ...
        cy.get('div').should('have.class', 'cu-container').and('have.class', 'bg-cu-black-50')
    ...
    it('Container with two column ', () => {
        ...
        cy.get('div').should('have.class', 'cu-container').and('have.class', 'bg-cu-black-50')
        cy.get('div').should('have.class', 'cu-column').and('have.class', 'md:grid-cols-2')
    })
    ...
    it('Container with two column Panel', () => {
        ...
        cy.get('div').should('have.class', 'cu-column').and('have.class', 'md:grid-cols-2')
        cy.get('div').should('have.class', 'cu-panel').and('have.class', 'shadow-lg')
